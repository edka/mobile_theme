...
<body>
<div data-role="page" data-theme="b" id="contact" data-position="inline">
...
<?php include('/data/verify.php'); ?>
	<form action="/contact.php" method="post" id="sendEmail">
		<div data-role="fieldcontain"> 
         ...
         <div data-role="fieldcontain" class="formbutton">
           <button type="submit" id="submit" data-theme="b">Send</button>
  ...
  <div data-role="footer" data-theme="b">
    <div class="ui-bar">
     <a href="index.html" data-role="button" data-icon="plus" data-theme="b">Home</a>
     <a href="" data-role="button" data-icon="star" data-theme="b">Facebook</a>
     <a href="" data-role="button" data-icon="star" data-theme="b">Twitter</a>
    </div>
  </div>
  <!-- /Footer --> 
</div>
