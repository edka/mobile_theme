...
<?php include('/data/verify.php'); ?>
	<form action="/contact.php" method="post" id="sendEmail">
		<div data-role="fieldcontain"> 
         ...
         <div data-role="fieldcontain" class="formbutton">
           <button type="submit" id="submit" data-theme="a">Send</button>
  ...
  <div data-role="footer" data-theme="a">
    <div class="ui-bar">
     <a href="index.html" data-role="button" data-icon="plus" data-theme="a">Home</a>
     <a href="" data-role="button" data-icon="star" data-theme="a">Facebook</a>
     <a href="" data-role="button" data-icon="star" data-theme="a">Twitter</a>
    </div>
  </div>
  <!-- /Footer --> 
</div>
