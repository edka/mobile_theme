...
<?php include('/data/verify.php'); ?>
	<form action="/contact.php" method="post" id="sendEmail">
		<div data-role="fieldcontain"> 
         ...
         <div data-role="fieldcontain" class="formbutton">
           <button type="submit" id="submit" data-theme="c">Send</button>
  ...
  <div data-role="footer" data-theme="d">
    <div class="ui-bar">
     <a href="index.html" data-role="button" data-icon="plus" data-theme="c">Home</a>
     <a href="" data-role="button" data-icon="star" data-theme="c">Facebook</a>
     <a href="" data-role="button" data-icon="star" data-theme="c">Twitter</a>
    </div>
  </div>
  <!-- /Footer --> 
</div>
